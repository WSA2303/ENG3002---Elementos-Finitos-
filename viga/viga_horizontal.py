...
# ============================================================
# CASO 1 - VIGA HORIZONTAL EM BALANCO
# Engaste no no 1 e carga vertical na ponta livre no no 2
# ============================================================

project_dir = Path(__file__).resolve().parent
data_dir = project_dir / "data"
output_dir = project_dir / "output" / "viga_horizontal"
data_dir.mkdir(exist_ok=True)
output_dir.mkdir(parents=True, exist_ok=True)

input_file = data_dir / "Viga2D_horizontal.txt"
